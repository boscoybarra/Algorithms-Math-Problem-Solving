...
TIP: Remember to put all of your object's properties and methods inside curly braces: var myObject = { greeting: "hello", name: "Julia" };.
Also, remember that an object is just another data type. Just like how you would put a semicolon after a string variable declaration var myString = "hello";,
...
var umbrella = {
    ...
    close: function() {
      if (umbrella.isOpen === false) {
        return "The umbrella is already cloded!"
      } else {
